...
plt.plot(ages_x, js_dev_y, label="JS Devs Salary")
...
df = pd.DataFrame(dev_y, columns=["salaries"])
median_val = df['salaries'].median()
print(median_val)

plt.plot(ages_x, dev_y, label="All Devs", linewidth=2, linestyle="--", color='black')

plt.fill_between(ages_x, js_dev_y, dev_y, alpha=0.25,
