...
ax1.plot(ages_x, py_dev_y, label="Python Devs")
ax1.plot(ages_x, js_dev_y, label="JS Devs Salary")
ax2.plot(ages_x, dev_y, label="All Devs", linewidth=2, linestyle="--", color='black')

ax1.legend()
ax1.set_title("All JS Developers Salary in USD")
